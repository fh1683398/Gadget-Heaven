...
const Header = ({scrollIntoSection}) => {
    return (
        <header className=''>
            ...
            <div className='bg-purple-500 rounded-2xl px-4 md:px-0'>
                ...
                <div className='text-center pt-12 pb-52 md:pb-72'>
                    ...
                    <Link onClick={()=> scrollIntoSection("products")} to=""><button className='px-6 py-2 rounded-full bg-white text-purple-500 font-semibold text-lg cursor-pointer'>Shop Now</button></Link>
                </div>
